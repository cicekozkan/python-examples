...
def make_color_dict(colors=COLORS):
    ...
    number = r'(\d+)'   # Matches the digits one or more times
    space = r'[ \t]*'   # Matches space or tab zero or more times
    name = r'([ \w]+)'  # Matches Alphanumeric characters plus "_" one or more times
